...
static final String Projectpath="D:\\class assignment";
...
public static void displayMenu()
{
	...
	System.out.println("\t\t Developer Name:Chetan Urkude\t\t");
	System.out.println("________________________________________________________________________");
	System.out.println("________________________________________________________________________");
	System.out.println("Kindly select below your activity options:\n");
...
public static void createfile() throws IOException
{
	...
	System.out.println("Enter how many line you want to add in this file");
	...
	FileWriter fw=new FileWriter(Projectpath+"\\"+fileName);
		...
		System.out.println("File is created successfully, please check in your path");
		fw.close();
	}
	catch(Exception ex)
	{
